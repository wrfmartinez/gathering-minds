  ...
  return (
    <section className="hero mx-auto max-w-7xl flex flex-col justify-center items-center gap-10 p-10 md:p-20 md:flex-row md:justify-around md:items-center">
      <div className="hero-text mt-20 md:w-[50%]">
        <h1 className="text-center md:text-start text-5xl font-bold mb-4">
          A place for the children of God to gather
        </h1>
        <p className="text-2xl mt-10 text-center sm:text-start">
        ...
        <p className="text-center text-md sm:pl-24 sm:pr-24 md:p-0 md:text-start font-semibold mt-10 opacity-50">&ldquo;Let us be concerned for one another, to help one another to show love and to do good. Let us not give up the habit of meeting together, as some are doing. Instead, let us encourage one another all the more, since you see that the Day of the Lord is coming nearer.&rdquo;</p>
        <p className="text-center text-xs md:text-start font-semibold mt-2 opacity-50">Hebrews 10:24-25</p>
      </div>
      <img
