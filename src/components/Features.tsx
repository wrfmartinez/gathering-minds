...
const Features = () => {
  return (
    <section className="features relative w-full p-10 md:p-0 flex flex-col gap-5 items-center text-center">
      <img
        className="absolute md:w-[170px] top-[65px] md:top-[200px] z-[-1]"
        src={stoneTabletDrawing}
        alt=""
      />
      <div className="mx-auto max-w-7xl p-20">
        <div className="mixed-text flex flex-col gap-5 items-center md:grid md:grid-row-3 w-full mb-20 text-xl md:text-3xl font-bold">
          <p>Christ Centered</p>
          <div className="w-full flex flex-col gap-5 md:pt-24 md:flex-row md:justify-between">
            <p>Prayer Sessions</p>
            <p>Bible Study</p>
          </div>
          <div className="w-full flex flex-col gap-5 md:flex-row md:justify-between md:pl-40 md:pr-40 md:pt-28">
            <p>Community</p>
            <p>Mentorship</p>
          </div>
        </div>
