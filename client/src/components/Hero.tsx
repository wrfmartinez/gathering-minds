const Hero = () => {
  return (
    <section className="hero flex flex-col justify-center items-center gap-10 p-20 md:flex-row md:justify-around md:items-center h-[100dvh]">
      <div className="hero-text md:w-[50%]">
        <h2 className="text-3xl font-bold mb-4">A place to gather with believers and grow in faith</h2>
